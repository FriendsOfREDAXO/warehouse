                ...
                <div class="page-content page-order">
                    ...
                    <table class="table table-bordered table-striped order_summary" id="table_order_summary">
                        ...
                        <tr class="tr_shipping">
                            ...
                            <td class="col2 text-right"><?= number_format(FriendsOfRedaxo\Warehouse\Warehouse::get_shipping_cost(), 2) ?></td>
                        </tr>
                        <tr class="tr_total">
                            <td class="bigtext col1">{{ Total }}</td>
                            <td class="bigtext col2 text-right"><?= number_format(FriendsOfRedaxo\Warehouse\Warehouse::get_cart_total(), 2) ?></td>
                        </tr>
                    </table>
