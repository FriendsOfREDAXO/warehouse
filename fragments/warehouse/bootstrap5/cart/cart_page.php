...
$containerClass = (null === $containerClass || false === $containerClass) ? 'container' : htmlspecialchars($containerClass);
			...
			<div class="card">
				...
				<div class="card-body" data-warehouse-item-key="<?= $item_key ?>">
					...
					<div class="row row-cols-1 row-cols-md-2 align-items-center g-0">
						...
						<!-- Other cells-->
						<div class="col">
							<div class="row row-cols-1 row-cols-sm-auto text-center g-3">
								<div class="col">
