...
class Cart extends rex_api_function
{
    ...
    {
        // index.php?rex-api-call=cart&action=set&article_id=1&variant_id=1&amount=1
        ...
        // index.php?rex-api-call=cart&action=add&article_id=1&variant_id=1&amount=1
        ...
        // index.php?rex-api-call=cart&action=modify&article_id=1&variant_id=1&amount=1&mode=add
        // index.php?rex-api-call=cart&action=modify&article_id=1&variant_id=1&amount=1&mode=remove
        // index.php?rex-api-call=cart&action=modify&article_id=1&variant_id=1&amount=1&mode=set
        ...
        // index.php?rex-api-call=cart&action=remove&article_id=1&variant_id=1&amount=1&mode=remove
        if (rex_request('action', 'string') == 'remove') {
            Warehouse::modifyCart(rex_request('article_id', 'int'), rex_request('variant_id', 'int', null), rex_request('amount', 'int', 1), rex_request('mode', 'string', 'remove'));
        }

        // index.php?rex-api-call=cart&action=delete&article_id=1&variant_id=1
        ...
        // index.php?rex-api-call=cart&action=empty
